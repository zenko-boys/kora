...
## API
- [x] revisar timezone do retorno da api
- [x] notificacao de leave antes de 24h para iniciar o jogo
- [x] nao podemos bookar dois jogos diferentes no mesmo horario, nem fazer join
- [x] verificar dayuse
